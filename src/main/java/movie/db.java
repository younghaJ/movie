...
public class db {
	...
	private String tmdbKey = "e9f48626c4f86f70cc4a49e2602b639c";
	private String kmdbKey = "f5eef3421c602c6cb7ea224104795888";
    ...
    public String load(int page, int date) {
    	Connection con = null;
		PreparedStatement pstmt = null;
		String sql = null;
		String year =  Integer.toString(date);
		String endpoint = "https://api.themoviedb.org/3/discover/movie?"
        		+ "api_key=" + tmdbKey + "&language=ko&region=KR"
    ...
    public String genre(int genreId) throws IOException {
    	...
    	String genreurl = "https://api.themoviedb.org/3/genre/movie/list?"
    			+ "api_key=" + tmdbKey + "&language=ko&id=12";
    	URL url;
		try {
    ...
    public String video(int movieid) {
    	String videokey = "";
    	String uri = "https://api.themoviedb.org/3/movie/" + movieid + "/videos?api_key=" + tmdbKey + "&language=ko";
    	URL url;
    ...
    public String production(int movieid) {
    	...
    	String uri = "https://api.themoviedb.org/3/movie/" + movieid + "?api_key=" + tmdbKey + "&language=ko";
    	URL url;
    ...
    public String provider(int movieid) {
    	String provider = "";
    	String uri = "https://api.themoviedb.org/3/movie/" + movieid + "/watch/providers?api_key=" + tmdbKey;
    	URL url;
